...
const points = () => {
    ...
    return (
        <div className='py-20 relative  flex flex-col justify-center items-center'>
            ...
            <div className='  w-[90%] lg:[75%] max-w-[500px] h-fit overflow-hidden flex flex-col justify-center mt-2  items-center rounded-lg  border-[1px] border-gray-500'>
            ...
            <div className=' mt-8'>
                <h3 className=' text-blue-400 tracking-wider cursor-pointer' onClick={viewDetails}>View Point wise Details</h3>
            </div>
        </div>
    )
}
