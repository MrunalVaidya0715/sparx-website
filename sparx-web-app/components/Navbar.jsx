  ...
  return (
    <div className={shadow ? ('fixed backdrop-blur-sm bg-[#030303]/90 w-full h-20 z-[100]') : ('fixed bg-[#030303] w-full h-20 z-[100]')}>
      ...
      <div className={nav ? 'md:hidden fixed left-0 top-0 h-full w-full bg-black/70' : ''}>
        <div className={nav ? 'fixed  right-0 top-0 bg-[#fe0109] bg-gradient-to-b from-[#fe0109] to-[#ad1015] px-4 py-0 h-screen w-[75%]  sm:w-[60%] md:w-[45%] ease-in duration-500' :
          'fixed  right-[-100%] top-0 bg-[#fe0109] p-10 h-screen w-[75%]  sm:w-[60%] md:w-[45%] ease-in duration-500'}>
